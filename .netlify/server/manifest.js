...
const manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["css/normalise.css", "css/style.css", "img/android-chrome-192x192.png", "img/android-chrome-256x256.png", "img/apple-touch-icon.png", "img/browserconfig.xml", "img/face-1.png", "img/favicon-16x16.png", "img/favicon-32x32.png", "img/favicon.ico", "img/logo.png", "img/mstile-150x150.png", "img/person/1.jpeg", "img/safari-pinned-tab.svg", "img/site.webmanifest", "js/script.js"]),
  _: {
